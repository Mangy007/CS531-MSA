...
void CACHE::bandwidth_calc(uint32_t cpu, CACHE *cache){       //Antra & Nupur
  ...
  if(counter > 1 && counter % 10000000 == 0){
    ...
    Epoch_Bandwidth = (double)CURR_ACCESS/10000000;
    cout << "Curr access " << CURR_ACCESS << " Epoch_Bandwidth = " << 100*Epoch_Bandwidth << endl;
    PREV_ACCESS = TOTAL_ACCESS;
    
    if(100*Epoch_Bandwidth >= 80){BLOCKS_TO_PREFETCH_A = 1;}
    else if(100*Epoch_Bandwidth >= 60){BLOCKS_TO_PREFETCH_A = 2;}
    else if(100*Epoch_Bandwidth >= 40){BLOCKS_TO_PREFETCH_A = 3;}
    else if(100*Epoch_Bandwidth >= 20){BLOCKS_TO_PREFETCH_A = 4;}
    else if(100*Epoch_Bandwidth >= 17){BLOCKS_TO_PREFETCH_A = 5;}
    else if(100*Epoch_Bandwidth >= 15){BLOCKS_TO_PREFETCH_A = 6;}
    else if(100*Epoch_Bandwidth >= 13){BLOCKS_TO_PREFETCH_A = 7;}
    else if(100*Epoch_Bandwidth >= 10){BLOCKS_TO_PREFETCH_A = 8;}
    else if(100*Epoch_Bandwidth >= 7){BLOCKS_TO_PREFETCH_A = 9;}
    else if(100*Epoch_Bandwidth >= 6){BLOCKS_TO_PREFETCH_A = 10;}
    else if(100*Epoch_Bandwidth >= 5){BLOCKS_TO_PREFETCH_A = 11;}
    else if(100*Epoch_Bandwidth >= 4){BLOCKS_TO_PREFETCH_A = 12;}
    else if(100*Epoch_Bandwidth >= 3){BLOCKS_TO_PREFETCH_A = 13;}
    else if(100*Epoch_Bandwidth >= 2){BLOCKS_TO_PREFETCH_A = 14;}
    else{BLOCKS_TO_PREFETCH_A = 15;}
    cout << "BLOCKS_TO_PREFETCH " << BLOCKS_TO_PREFETCH_A << endl;
  }
}

// int CACHE::num_of_blocks_to_prefetch(){
//   if(1000*Epoch_Bandwidth >= 2){
//     return 1;
//   }
//   else{
//     return 2;
...
void CACHE::operate()
{
    ...
    // if(cache_type == IS_LLC){         //Antra & Nupur
    //   bandwidth_calc(0,&uncore.LLC);
    // }
}
